import { LOAD_ALL, START_LOADING, LOAD_ITEMS, DELETE_ITEM_FINISHED } from "./types";
...
const storeReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case DELETE_ITEM_FINISHED:
            return {...state, currentItems: _.dropRightWhile(state.currentItems, {'id':action.payload})  , loading: false };
