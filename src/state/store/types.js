...
export const LOAD_ALL = '[STORE] LOAD_ALL';

//Items
export const FETCH_ITEMS = '[STORE] FETCH_ITEMS';
export const LOAD_ITEMS = '[STORE] LOAD_ITEMS';
...
export const DELETE_ITEM_FINISHED = '[STORE] DELETE_ITEM_FINISHED';
